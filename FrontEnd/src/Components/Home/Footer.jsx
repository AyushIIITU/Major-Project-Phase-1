...
function Footer() {
  return (
    // <!--Footer container-->
    <footer className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white w-full">
      ...
      <div className="w-full bg-black/5 p-4 text-center cursor-pointer">
        ...
        <Link to="https://iiitu.ac.in/"className="text-blue-900" >IIIT Una</Link>
      </div>
    </footer>
  )
}
